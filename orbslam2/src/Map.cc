...
void Map::Save(const string& filename){
    ...
    f.open(filename.c_str(), ios_base::out|ios::binary);    //nota:
                                                            ...
                                                            //  ios_base::out specifies that the file should be opened for writing.
                                                            //  ios::binary specifies that the file should be treated as a binary file, rather than a text file.
