    ...
    mbFinishRequested(false), mbFinished(true), mbStopped(true), mbStopRequested(false)
{
    ...
    */
    ...
    string onnx_model_path = "yolo/models/best-seg-480-640.onnx";
    cv::Size modelInputShape(640, 480);
    string classesTxtFile = "yolo/classes.txt";
    bool runWithCuda = true;

    // init yolo inference
    inf = new YOLO::Inference(onnx_model_path, modelInputShape, classesTxtFile, runWithCuda);
    // =========================================================================

    // ===OPEN CONE COORDINATES LOG FILE======================================== 
    log_cone_csv_file.open(log_cone_file_path);
